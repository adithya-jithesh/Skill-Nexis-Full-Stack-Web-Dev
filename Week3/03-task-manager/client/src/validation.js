...
// The limit is a parameter because the schema's is, and the two have to
// agree - a task allows 1000 characters here.
export function validateDescription(description, max = 1000) {
  if (description.length > max) return "Description cannot be longer than " + max + " characters.";
  return "";
}
