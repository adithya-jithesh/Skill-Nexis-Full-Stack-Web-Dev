...
export async function login(req, res) {
  ...
  // password is wrong, so the login route cannot be used to find out which
...
// GET /api/auth/me - protected. The client calls this on startup to check
// that the token it kept from last time is still good.
